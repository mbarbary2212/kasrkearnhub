...
interface BulkSectionAssignmentProps {
  ...
  topicId?: string;
  selectedIds: string[];
  contentTable: 'lectures' | 'resources' | 'mcq_sets' | 'mcqs' | 'essays' | 'practicals' | 'study_resources' | 'osce_questions' | 'matching_questions' | 'virtual_patient_cases' | 'true_false_questions' | 'case_scenarios';
  onComplete?: () => void;
}
