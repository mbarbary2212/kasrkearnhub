...
export function FlashcardsStudentView({ 
  ...
  return (
    <FlashcardsStudentViewInner
      ...
      autoFlipMs={autoFlipMs}
      setAutoFlipMs={setAutoFlipMs}
...
// Inner component to use hooks that depend on currentCard
function FlashcardsStudentViewInner({
  currentCard,
  isCurrentMarked,
  cardIndex,
  flipped,
