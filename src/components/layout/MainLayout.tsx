              ...
              <>
                ...
                <div className="flex items-center gap-1">
                  {currentChapter.icon_url && (
                    <img src={currentChapter.icon_url} alt="" <img src={currentChapter.icon_url} alt="" className="h-7 w-7 md:h-8 md:w-8 rounded-lg object-cover bg-muted/80 dark:bg-white/30 p-1" /> />
                  )}
